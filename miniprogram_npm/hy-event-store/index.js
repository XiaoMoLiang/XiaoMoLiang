...
__DEFINE__(1646788022071, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1646788022072,"./event-store":1646788022073}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1646788022072, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1646788022073, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1646788022072,"./utils":1646788022074}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1646788022074, function(require, module, exports) {
...
return __REQUIRE__(1646788022071);
})()
